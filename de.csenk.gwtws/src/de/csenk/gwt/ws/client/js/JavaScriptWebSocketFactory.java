...
import de.csenk.gwt.ws.client.WebSocketFactory;
...
public class JavaScriptWebSocketFactory implements WebSocketFactory {
	...
	/* (non-Javadoc)
	 * @see de.csenk.gwt.ws.client.WebSocketFactory#createWebSocket(java.lang.String, de.csenk.gwt.ws.client.WebSocketCallback)
	 */
	@Override
