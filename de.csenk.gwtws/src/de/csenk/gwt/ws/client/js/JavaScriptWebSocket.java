...
package de.csenk.gwt.ws.client.js;
...
public class JavaScriptWebSocket implements WebSocket {
	...
	/* (non-Javadoc)
	 * @see de.csenk.gwt.ws.client.js.WebSocket#send(java.lang.String)
	 */
	@Override
	public native void send(String message) /*-{
		...
		this.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::jsWebSocket.send(message);
	}-*/;
	
	/* (non-Javadoc)
	 * @see de.csenk.gwt.ws.client.js.WebSocket#close()
	 */
	@Override
	public native void close() /*-{
		this.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::jsWebSocket.close();
	}-*/;
	
	/* (non-Javadoc)
	 * @see de.csenk.gwt.ws.client.js.WebSocket#getBufferedAmount()
	 */
	@Override
	public native int getBufferedAmount() /*-{
		return this.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::jsWebSocket.bufferedAmount;
	}-*/;
	
	/* (non-Javadoc)
	 * @see de.csenk.gwt.ws.client.js.WebSocket#getReadyState()
	 */
	@Override
	public native int getReadyState() /*-{
		return this.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::jsWebSocket.readyState;
	}-*/;
	
	/* (non-Javadoc)
	 * @see de.csenk.gwt.ws.client.js.WebSocket#getURL()
	 */
	@Override
	public native String getURL() /*-{
		return this.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::jsWebSocket.url;
	}-*/;
	...
	private native JavaScriptObject createJSWebSocket(final String url, final WebSocket webSocket) /*-{
		...
		jsWebSocket.onopen = function() {
			webSocket.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::onOpen()();
		}
		
		jsWebSocket.onclose = function() {
			webSocket.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::onClose()();
		}
		
		jsWebSocket.onerror = function() {
			webSocket.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::onError()();
		}
		
		jsWebSocket.onmessage = function(socketResponse) {
			if (socketResponse.data) {
				webSocket.@de.csenk.gwt.ws.client.js.JavaScriptWebSocket::onMessage(Ljava/lang/String;)(socketResponse.data);
			}
		}
