...
public class ServerMessageDispatchingHandlerTest extends TestCase {
	...
	/**
	 * Test method for {@link de.csenk.gwt.ws.server.handler.ServerMessageDispatchingHandler#onExceptionCaught(de.csenk.gwt.ws.shared.Connection, java.lang.Throwable)}.
	 */
	...
	/**
	 * Test method for {@link de.csenk.gwt.ws.server.handler.ServerMessageDispatchingHandler#onMessageReceived(de.csenk.gwt.ws.shared.Connection, java.lang.Object)}.
	 * @throws Throwable 
	 */
	@SuppressWarnings("unchecked")
